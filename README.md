...
Tous les fichiers sont à la racine — pas de sous-dossier, pour pouvoir les déplacer/copier librement sans casser les chemins.
...
1. les déposer à la racine du dossier (ex. `hero.jpg`)
2. remplacer chaque `src` correspondant dans `index.html`
